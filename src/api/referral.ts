...
export interface ReferralConfig { rewardType: 'lesson_credit' | 'credit' | 'free_lesson' | 'discount_percent'; rewardValue: number; requiresApproval: boolean; refereeRewardValue: number; isActive: boolean }
